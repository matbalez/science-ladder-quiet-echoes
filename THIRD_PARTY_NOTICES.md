...
The 2026 follow-up paper and circle-packing/Golomb sources are cited as evidence. Their prose, figures and solver implementations are not included. Source response hashes are retained in `docs/scout-provenance.json`; source bodies remain separate research intermediates.
